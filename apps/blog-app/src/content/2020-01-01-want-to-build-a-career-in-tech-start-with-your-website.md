---
title: Want to build a career in TECH? — start with your WEBSITE!
slug: 2020-01-01-want-to-build-a-career-in-tech-start-with-your-website
...
<img src="https://cdn.buttercms.com/0qCMHkcDSA64DOE4D9sK" alt="Want to build a career in TECH? — start with your WEBSITE!" width="100%" />
...
My old website (https://dalenguyen.me) was created by using PHP Laravel Framework and hosted on Microsoft Azure. It served me well when I searched for a Developer position a few years ago. Now, it's time to revamp it because technology has changed and my startup account on Microsoft is going to expired.

In this article, I will show you how to build your personal website in order to bootstrap or advance your career in tech.

## Step one— Get a domain name ([Namecheap](https://www.namecheap.com/?aff=86050))
...
How to build a website with Angular and Github Pages

P/S: I was working on a project that can get articles from DEV.TO (Thanks DEV.TO team) and show them on my personal website, so I don't have to create one. Then I moved to ButterCMS.

Here is the working product: [https://dalenguyen.me/blog](https://dalenguyen.me/blog). I will post another article that explains how I do it later. So stay tuned ;)
